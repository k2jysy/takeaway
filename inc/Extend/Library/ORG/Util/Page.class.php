...
class Page {
	...
	'first'=>'1..',
	'last'=>'...',
	'theme'=>' <li><a href="javascript:void(0);"> %nowPage%/%totalPage% 页 </a></li>  %upPage%  %first%   %linkPage%   %end% %downPage% ');
 
	
	// 默认分页变量名<li><a href="javascript:void(0);"> %totalRow%  %header% </a></li>
    protected $varPage;
        ...
        for($i=1;$i<=$this->rollPage;$i++){
            ...
            if($page!=$this->nowPage){
                ...
                if($this->totalPages != 1){
                    $linkPage .= "<li class='active'><a href='#'>".$page."<span class='sr-only'>(current)</span></a></li>";
                }
            }
        }
        $pageStr     =   str_replace(
