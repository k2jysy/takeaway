  ...
  <section class="section">
      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="supercms" class="input"></td>
            <td><div id="J_install_tip_dbname"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库表前缀：</td>
            <td><input type="text" name="dbprefix" id="dbprefix" value="sn_" class="input"></td>
            <td><div id="J_install_tip_dbprefix"><span class="gray">建议使用默认，同一数据库安装多个SuperCms时需修改</span></div></td>
          </tr>
        </table>
		<table width="100%">
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="sitename" value="超级外卖微信订餐系统" class="input"></td>
          ...
          <tr>
            ...
            <td><div id="J_install_tip_siteurl"><span class="gray">若你的程序安装在目录下，请增加目录名。不加'/'结尾</span></div></td>
          </tr>
          <tr>
            <td class="tar">关键词：</td>
            <td><input type="text" name="sitekeywords" value="超级外卖订餐" class="input" autoComplete="off"></td>
            <td><div id="J_install_tip_sitekeywords"></div></td>
          </tr>
          <tr>
            <td class="tar">描述：</td>
            <td><input type="text" name="siteinfo" class="input" value="超级外卖订餐"></td>
   ...
   <!--     <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="manager" value="admin888" class="input"></td>
